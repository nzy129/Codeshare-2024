...
sum avefare nonstop roundtrip online_new interline t_codeshare v_codeshare mktcoupons mktdistance nonstopmiles ///
...
mktdistance mktdistance2 b6aa WN AA DL UA NK AS B6 F9 G4 HA SY ///
...
reg avefare roundtrip nonstop interline online_new mktdistance mktdistance2 1.b6aa#1.AA 1.b6aa#1.B6 WN AA DL UA NK AS B6 F9 G4 HA SY ///
...
reg lnfare roundtrip nonstop interline online_new mktdistance mktdistance2 1.b6aa#1.AA 1.b6aa#1.B6 WN AA DL UA NK AS B6 F9 G4 HA SY ///
XP MX MM nea_market nea_market_codeshared i.dt[aweight = passengers]
