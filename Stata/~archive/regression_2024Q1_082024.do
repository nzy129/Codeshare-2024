...
foreach var of local quantile_list {
    * Run the regression model
    quietly reg `var' roundtrip nonstop mktdistance100 mktdistance1002 hub ///
	 t_codeshare v_codeshare pure_online ///
 1.b6aa_c#1.AA 1.b6aa_c#1.B6 WN AA DL UA NK AS B6 F9 G4 HA SY XP MX MM  ///
 nea_market_codeshared 1.nea_market_codeshared#1.dummy_bos 1.nea_market_codeshared#1.dummy_jfk ///
1.nea_market_codeshared#1.dummy_ewr 1.nea_market_codeshared#1.dummy_lga i.dt i.mktgroupid [aweight = passengers], cluster(market)
...
graph export "Price_Dispersion_MFE_BOS_carriergroup_abs.png", replace
...
recast(connected)  ciopts(recast(rarea) color(gs14) lpattern(dash)) ///
graphregion(color(white)) plotregion(color(white))
graph export "Price_Dispersion_MFE_JFK_carriergroup_abs.png", replace
...
recast(connected)  ciopts(recast(rarea) color(gs14) lpattern(dash)) ///
graphregion(color(white)) plotregion(color(white))
graph export "Price_Dispersion_MFE_LGA_carriergroup_abs.png", replace
...
recast(connected)  ciopts(recast(rarea) color(gs14) lpattern(dash)) ///
graphregion(color(white)) plotregion(color(white))
graph export "Price_Dispersion_MFE_EWR_carriergroup_abs.png", replace
...
recast(connected)  ciopts(recast(rarea) color(gs14) lpattern(dash)) ///
graphregion(color(white)) plotregion(color(white))
graph export "Price_Dispersion_MFE_Other_carriergroup_abs.png", replace
...
recast(connected)  ciopts(recast(rarea) color(gs14) lpattern(dash)) ///
graphregion(color(white)) plotregion(color(white))
graph export "Price_Dispersion_MFE_New_Market_abs.png", replace
...
recast(connected)  ciopts(recast(rarea) color(gs14) lpattern(dash)) ///
graphregion(color(white)) plotregion(color(white))
graph export "Price_Dispersion_MFE_NonNew_Market_abs.png", replace
********************************************************************************
**# DID: Direct Flight 
********************************************************************************
...
reg mktfare roundtrip hub v_codeshare  pure_online ///
 WN AA DL UA NK AS B6 F9 G4 HA SY XP MX MM  ///
 1.nea_market_codeshared JetBlue_new_market_served ///
 1.nea_market_codeshared#1.JetBlue_new_market_served ///
 i.dt i.mktgroupid [aweight = passengers], cluster(market)

reg MktFare_sd roundtrip hub v_codeshare  pure_online ///
 WN AA DL UA NK AS B6 F9 G4 HA SY XP MX MM  ///
 1.nea_market_codeshared JetBlue_new_market_served ///
 1.nea_market_codeshared#1.JetBlue_new_market_served ///
 i.dt i.mktgroupid [aweight = passengers], cluster(market)
...
foreach var of local dependent_vars {
    * Run the regression model
    quietly reg ln`var' roundtrip hub v_codeshare  pure_online ///
 WN AA DL UA NK AS B6 F9 G4 HA SY XP MX MM  ///
 1.nea_market_codeshared JetBlue_new_market_served ///
 1.nea_market_codeshared#1.JetBlue_new_market_served ///
 i.dt i.mktgroupid [aweight = passengers], cluster(market)
...
foreach var of local dependent_vars {
    * Run the regression model
    quietly reg `var' roundtrip hub v_codeshare  pure_online ///
 WN AA DL UA NK AS B6 F9 G4 HA SY XP MX MM  ///
 1.nea_market_codeshared JetBlue_new_market_served ///
 1.nea_market_codeshared#1.JetBlue_new_market_served ///
 i.dt i.mktgroupid [aweight = passengers], cluster(market)
...
recast(connected)  ciopts(recast(rarea) color(gs14) lpattern(dash)) ///
graphregion(color(white)) plotregion(color(white))
graph export "Price_Dispersion_MFE_JB_DirectFlight_abs.png", replace 
...
recast(connected)  ciopts(recast(rarea) color(gs14) lpattern(dash)) ///
graphregion(color(white)) plotregion(color(white))
graph export "Price_Dispersion_MFE_DirectFlight_abs.png", replace 
*** End of File
